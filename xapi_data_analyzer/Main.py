...
def use_id_list(id_list, timestamp):
    ...
    test_dict = {}
    for student in GlobalData.class_list:
        test_dict[student] = "test@wisc.edu"
    element_collection = ElementCollection(id_list, GlobalData.raw_data, GlobalData.class_list, test_dict)
...
def use_json(timestamp, day_dict_list):
    ...
    for i, day in enumerate(day_dict_list, 1):
        ...
        element_collection = ElementCollection(day_ids, GlobalData.raw_data, GlobalData.class_list, test_dict)
